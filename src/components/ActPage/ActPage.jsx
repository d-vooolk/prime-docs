...
import {HeadlightActDescription} from "./Descriptions/HeadlightActDescription";

const ActPage = ({customerData, date, serviceOption}) => {
    return (
        <div id="printableAct">
            ...
            <div>
                ...
                { serviceOption === SERVICE_OPTIONS_NAMES.headlights && (<HeadlightActDescription customerData={customerData} />) }
