    ...
    return (
        <div id="printableAct">
            ...
            <div>
                ...
                <div>
                    Претензии не принимаются в случае не соблюдения заказчиком правил технической эксплуатации, дорожно-транспортного происшествия, при ремонте установленного агрегата, узла, детали, без предъявления автотранспортного средства на предприятие автосервиса, а также в случае предъявления претензий после установленного срока. Гарантийный срок начинает исчисляться со дня приёмки потребителем транспортного средства или агрегата. Предприятие не устанавливает гарантии на запчасти предоставленные заказчиком для ремонта. Претензии по качеству и объему выполненных услуг по обслуживанию могут быть предъявлены заказчиком в течении следующих гарантийных сроков: <br />
                    - работы проведённые по доработке узла фар ТС - в течение 365 дней при пробеге не более 50000 км; <br />
            ...
            <div className="bold biggest margin-bottom-10">Контроль полноты, качества работ, комплектность и проверку технического состояния автомобиля произвл:</div>
